...
for(j=0; j<nPhotos; j++){
	...
	if(imagesSequential == 1){
        ...
        if(photoSettings[0] == "uv"){
            ...
            imagePath="C:\\Users\\timre\\Desktop\\Snake Pattern\\DSC_1415.jpg";
        }
        // END MY CODE!!!
...
makeLine(0, 0, 300, 300);
roiManager("add");
roiManager("select", 0);
roiManager("rename", "Scale Bar:76.0:98");
roiManager("deselect")

mask = File.openAsString("C:\\Users\\timre\\Desktop\\Snake Pattern\\Mask.txt");
points = split(mask, "\n");
pointsX = split(points[1], " ");
pointsY = split(points[0], " ");
makeSelection("freeline",pointsX,pointsY);
roiManager("add");

//open("C:\\Users\\timre\\Desktop\\Snake Pattern\\DSC_1415mask.jpg")
//close("*");